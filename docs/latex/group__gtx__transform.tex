...
\subsubsection[{rotate(\+T angle, tvec3$<$ T, P $>$ const \&v)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L tmat4x4$<$T, P$>$ glm\+::rotate (
...
\subsubsection[{scale(tvec3$<$ T, P $>$ const \&v)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L tmat4x4$<$T, P$>$ glm\+::scale (
\begin{DoxyParamCaption}
\item[{tvec3$<$ T, P $>$ const \&}]{v}
\end{DoxyParamCaption}
...
\subsubsection[{translate(tvec3$<$ T, P $>$ const \&v)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L tmat4x4$<$T, P$>$ glm\+::translate (
\begin{DoxyParamCaption}
\item[{tvec3$<$ T, P $>$ const \&}]{v}
\end{DoxyParamCaption}
