...
public:
	...
	inline btVector3 GetBT() const
	{
		return btVector3(GetX(), 0, GetY());
	}

	inline static Vector2<T> GetFT(const btVector3& bt)
	{
		return Vector2<T>(bt.getX(), bt.getY());
	}
...
public:
	...
	inline btVector3 GetBT() const
	{
		return btVector3(GetX(), GetY(), GetZ());
	}

	inline static Vector3<T> GetFT(const btVector3& bt)
	{
		return Vector3<T>(bt.getX(), bt.getY(), bt.getZ());
	}
...
public:
	...
	inline btVector4 GetBT() const
	{
		return btVector4(GetX(), GetY(), GetZ(), GetW());
	}

	inline static Vector4<T> GetFT(const btVector4& bt)
	{
		return Vector4<T>(bt.getX(), bt.getY(), bt.getZ(), bt.getW());
	}
...
public:
	...
	inline btQuaternion GetBT() const
	{
		return btQuaternion(GetX(), GetY(), GetZ(), GetW());
	}

	inline static Quaternion GetFT(const btQuaternion& bt)
	{
		return Quaternion(bt.getX(), bt.getY(), bt.getZ(), bt.getW());
	}
