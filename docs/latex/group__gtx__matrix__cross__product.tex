...
\subsubsection[{matrix\+Cross3(tvec3$<$ T, P $>$ const \&x)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L tmat3x3$<$T, P$>$ glm\+::matrix\+Cross3 (
...
\subsubsection[{matrix\+Cross4(tvec3$<$ T, P $>$ const \&x)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L tmat4x4$<$T, P$>$ glm\+::matrix\+Cross4 (
\begin{DoxyParamCaption}
\item[{tvec3$<$ T, P $>$ const \&}]{x}
\end{DoxyParamCaption}
