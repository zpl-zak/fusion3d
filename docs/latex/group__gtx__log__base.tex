...
\subsubsection[{log(gen\+Type x, gen\+Type base)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename gen\+Type $>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L gen\+Type glm\+::log (
...
\subsubsection[{sign(vec\+Type$<$ T, P $>$ const \&x, vec\+Type$<$ T, P $>$ const \&base)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P, template$<$ typename, precision $>$ class vec\+Type$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L vec\+Type$<$T, P$>$ glm\+::sign (
\begin{DoxyParamCaption}
