...
\subsubsection[{linear\+Gradient(tvec2$<$ T, P $>$ const \&\+Point0, tvec2$<$ T, P $>$ const \&\+Point1, tvec2$<$ T, P $>$ const \&\+Position)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L T glm\+::linear\+Gradient (
...
\subsubsection[{radial\+Gradient(tvec2$<$ T, P $>$ const \&\+Center, T const \&\+Radius, tvec2$<$ T, P $>$ const \&\+Focal, tvec2$<$ T, P $>$ const \&\+Position)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L T glm\+::radial\+Gradient (
\begin{DoxyParamCaption}
