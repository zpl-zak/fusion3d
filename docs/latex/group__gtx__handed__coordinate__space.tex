...
\subsubsection[{left\+Handed(tvec3$<$ T, P $>$ const \&tangent, tvec3$<$ T, P $>$ const \&binormal, tvec3$<$ T, P $>$ const \&normal)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L bool glm\+::left\+Handed (
...
\subsubsection[{right\+Handed(tvec3$<$ T, P $>$ const \&tangent, tvec3$<$ T, P $>$ const \&binormal, tvec3$<$ T, P $>$ const \&normal)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L bool glm\+::right\+Handed (
\begin{DoxyParamCaption}
\item[{tvec3$<$ T, P $>$ const \&}]{tangent, }
\item[{tvec3$<$ T, P $>$ const \&}]{binormal, }
\item[{tvec3$<$ T, P $>$ const \&}]{normal}
