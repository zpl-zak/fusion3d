...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
	...
	if (ImGui::TreeNode("Colors"))
	{
		...
		ImGui::Combo("##output_type", &output_dest, "To Clipboard\0To TTY");
		ImGui::PopItemWidth();
		ImGui::SameLine();
...
static void ShowExampleAppCustomRendering(bool* opened)
{
	...
	ImGui::ColorEdit3("Color", &col.x);
	{
		...
		draw_list->AddCircle(ImVec2(x + sz * 0.5f, y + sz * 0.5f), sz * 0.5f, col32, 32);
		x += sz + spacing;
		...
		x += sz + spacing;
		draw_list->AddLine(ImVec2(x, y), ImVec2(x + sz, y), col32, 4.0f);
		x += sz + spacing;
		draw_list->AddLine(ImVec2(x, y), ImVec2(x + sz, y + sz), col32, 4.0f);
		x += sz + spacing;
		draw_list->AddLine(ImVec2(x, y), ImVec2(x, y + sz), col32, 4.0f);
		x += spacing;
		draw_list->AddBezierCurve(ImVec2(x, y), ImVec2(x + sz * 1.3f, y + sz * 0.3f), ImVec2(x + sz - sz * 1.3f, y + sz - sz * 0.3f), ImVec2(x + sz, y + sz), col32, 4.0f);
		x += sz + spacing;
