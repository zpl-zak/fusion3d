...
\subsubsection[{fast\+Normalize\+Dot(vec\+Type$<$ T, P $>$ const \&x, vec\+Type$<$ T, P $>$ const \&y)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P, template$<$ typename, precision $>$ class vec\+Type$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L T glm\+::fast\+Normalize\+Dot (
...
\subsubsection[{normalize\+Dot(vec\+Type$<$ T, P $>$ const \&x, vec\+Type$<$ T, P $>$ const \&y)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P, template$<$ typename, precision $>$ class vec\+Type$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L T glm\+::normalize\+Dot (
\begin{DoxyParamCaption}
\item[{vec\+Type$<$ T, P $>$ const \&}]{x, }
\item[{vec\+Type$<$ T, P $>$ const \&}]{y}
\end{DoxyParamCaption}
