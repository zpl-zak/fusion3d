...
\subsubsection[{euclidean(tvec2$<$ T, P $>$ const \&polar)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L tvec3$<$T, P$>$ glm\+::euclidean (
...
\subsubsection[{polar(tvec3$<$ T, P $>$ const \&euclidean)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L tvec3$<$T, P$>$ glm\+::polar (
\begin{DoxyParamCaption}
