...
\subsubsection[{proj(vec\+Type const \&x, vec\+Type const \&\+Normal)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename vec\+Type $>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L vec\+Type glm\+::proj (
