...
\subsubsection[{extend(gen\+Type const \&\+Origin, gen\+Type const \&\+Source, typename gen\+Type\+::value\+\_\+type const Length)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename gen\+Type $>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L gen\+Type glm\+::extend (
