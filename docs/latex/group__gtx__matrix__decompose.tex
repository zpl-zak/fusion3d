...
\subsubsection[{decompose(tmat4x4$<$ T, P $>$ const \&model\+Matrix, tvec3$<$ T, P $>$ \&scale, tquat$<$ T, P $>$ \&orientation, tvec3$<$ T, P $>$ \&translation, tvec3$<$ T, P $>$ \&skew, tvec4$<$ T, P $>$ \&perspective)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L bool glm\+::decompose (
\begin{DoxyParamCaption}
\item[{tmat4x4$<$ T, P $>$ const \&}]{Model\+Matrix, }
\item[{tvec3$<$ T, P $>$ \&}]{Scale, }
\item[{{\bf tquat}$<$ T, P $>$ \&}]{Orientation, }
