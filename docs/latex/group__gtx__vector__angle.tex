...
\subsubsection[{angle(vec\+Type const \&x, vec\+Type const \&y)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename vec\+Type $>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L vec\+Type\+::value\+\_\+type glm\+::angle (
...
\subsubsection[{oriented\+Angle(tvec2$<$ T, P $>$ const \&x, tvec2$<$ T, P $>$ const \&y)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L T glm\+::oriented\+Angle (
\begin{DoxyParamCaption}
...
\index{oriented\+Angle@{oriented\+Angle}!G\+L\+M\+\_\+\+G\+T\+X\+\_\+vector\+\_\+angle@{G\+L\+M\+\_\+\+G\+T\+X\+\_\+vector\+\_\+angle}}
\subsubsection[{oriented\+Angle(tvec3$<$ T, P $>$ const \&x, tvec3$<$ T, P $>$ const \&y, tvec3$<$ T, P $>$ const \&ref)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , precision P$>$ G\+L\+M\+\_\+\+F\+U\+N\+C\+\_\+\+D\+E\+C\+L T glm\+::oriented\+Angle (
\begin{DoxyParamCaption}
